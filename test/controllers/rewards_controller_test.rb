...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference("Reward.count") do
      post rewards_url, params: { reward: { cost: @reward.cost, expire_at: @reward.expire_at, minutes: @reward.minutes, order: @reward.order, title: @reward.title, user_id: @reward.user_id, uses: @reward.uses } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { cost: @reward.cost, expire_at: @reward.expire_at, minutes: @reward.minutes, order: @reward.order, title: @reward.title, user_id: @reward.user_id, uses: @reward.uses } }
